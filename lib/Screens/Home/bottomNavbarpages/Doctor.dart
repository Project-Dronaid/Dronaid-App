                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                        Text('Best Offers',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: size.height*0.03),),
                                        Text('Explore deals, offers, health updates and more',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600,fontSize: size.height*0.014),),
                                    ],
                                  ),
                                ),
                              ],
